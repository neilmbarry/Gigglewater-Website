...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <h2 class="title-push">Cocktail Kits</h2>
      ...
      <div class="menu-container">
          <div class="menu-item">
              <div class="menu-item_pic">
                  <img src="/Resources/new/pine.jpg" alt="cocktail-pic">
              </div>
              ...
              <div class="menu-item_btn" id="pine">
                  Add to cart!
              </div>
          </div>
          ...
          <div class="menu-item">
              <div class="menu-item_pic">
                  <img src="/Resources/new/blueb2.jpg" alt="cocktail-pic">
              </div>
              <div class="menu-item_title">
                  DEEP DIVE
              </div>
              ...
              <div class="menu-item_btn" id="deep">
                  Add to cart!
              </div>
          </div>
          <div class="menu-item">
              <div class="menu-item_pic">
                  <img src="/Resources/new/mango.jpg" alt="cocktail-pic">
              </div>
              <div class="menu-item_title">
                  THE MANGOLORIAN
              </div>
              ...
              <div class="menu-item_btn" id="mango">
                  Add to cart!
              </div>
          </div>
          <div class="menu-item">
              <div class="menu-item_pic">
                  <img src="/Resources/new/strawb.jpg" alt="cocktail-pic">
              </div>
              <div class="menu-item_title">
                  THE LAFFY TAFFY
              </div>
      ...
      <h2>Pre-blended</h2>
      <h4 class="cocktail-description">
      Boozy, Spirit Forward - Presented as 473ml bottled cocktail - Makes 5+ Servings
      </h4>
      ...
      <div class="menu-container">
          ...
          <div class="menu-item">
              ...
              <div class="menu-item_btn" id="potChips">
                  Add to cart!
              </div>
          </div>
          ...
          <div class="menu-item">
            <div class="menu-item_pic">
                <img src="/Resources/new/ONYX_Box4.jpg" alt="cocktail-pic">
            </div>
            <div class="menu-item_title">
                Onyx Box Assorted Bon-Bons
            </div>
            <!-- <div class="menu-item_description">
                APPLETON SIGNATURE RUM
            </div> -->
