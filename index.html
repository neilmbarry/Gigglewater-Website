  ...
  <body>
    ...
    <header class="header">
      ...
      <div class="header-box">
        ...
        <!-- <p>DELETE ABOVE AND UNDEDLETE BELOW</p> -->
        <!-- <div class="order-by">
        ...
        <!-- <div class="order-by">
          <i class="pink margin-right fa-regular fa-clock"></i> 6PM - 2AM,
          Tuesday - Sunday
        </div> -->
        <!-- <div class="order-by">
    ...
    <footer class="footer">
      ...
      >
        <a
          href="https://restaurantguru.com/Project-Gigglewater-Toronto"
          class="r-rcm_r-link"
          target="blank"
          >Project Gigglewater</a
        >
        <div class="r-rcm_year">2023</div>
        <div class="r-rcm_bottom">
          <span class="r-rcm_str1">Recommended</span>
        </div>
        <div class="r-rcm_heading">
          ...
          >
            ...
            <text class="r-rcm_headingbottom" fill="#fff" text-anchor="middle">
              <textPath startOffset="50%" xlink:href="#r-rcm-arc">
                <a
                  href="https://restaurantguru.com/"
                  class="r-rcm_heading_link"
                >
                  Restaurant Guru
                </a>
              </textPath>
