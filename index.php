  ...
  <body>
      ...
      <div class="cart-contents">
        <div class="cart-item" id="${i}">
          ...
          <div class="cart-item-price">
            $${menuItemRef[item].price.toFixed(2)}
          </div>
          ...
          <div class="contact-options">
            ...
            <div class="contact-option contact-option-delivery">
              ...
              <div class="contact-item postage">
                ...
                <input
                  class="contact-input contact-input_post"
                  type="text"
                  id="contact-postcode"
                />
        ...
        <div class="summary-item">
          ...
          <div class="summary-item-info2">
            <div class="summary-tip">
              <div class="summary-tip-option-1 summary-tip-option summary-tip-option_active">15%</div>
              <div class="summary-tip-option-2 summary-tip-option">20%</div>
              <div class="summary-tip-option-3 summary-tip-option">25%</div>
    ...
    <nav class="nav">
      ...
      <ul class="nav-items nav-items_hide">
        ...
        <li class="nav-list-item"><a href="/gallery.php" class="nav-item">Gallery</a></li>
...
<!-- class is "nav-sticky" -->
    <header class="header">
      ...
      <div class="header-box">
        ...
        <a href="/cocktails.php" class="btn btn-cta btn-header"
          >Order cocktails <span class="btn-arrow">&#8594;</span></a
        >
      </div>
    </header>
    <section class="section-about">
      <h2 class="section-about-title title-hidden">
        Explore our libation offerings
      </h2>
      <div class="cards-container card-blur">
        <div class="cards-container-card">
          ...
          <a href="/cocktails.php" class="btn btn-cta btn-card">Order Kits</a>
        </div>
        <div class="cards-container-card">
          <div
          ...
          <a href="/cocktails.php#blended" class="btn btn-cta btn-card">Order Bottles</a>
        </div>
        <div class="cards-container-card">
          <div
          ...
          <a href="/merch.php" class="btn btn-cta btn-card">Order merch</a>
        </div>
      </div>
      <a href="/cocktails.php" class="btn btn-cta btn-about"
    ...
    <section class="section-reviews">
      <h2 class="section-reviews-title title-hidden">
        Hear what our guests had to say
      </h2>
