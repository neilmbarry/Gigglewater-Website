  ...
  <body>
    ...
    <nav class="nav">
      ...
      <ul class="nav-items nav-items_hide">
        ...
        <!-- <li class="nav-list-item">
          <a href="/groups" class="nav-item">Corporate / Groups</a>
        </li> -->
        <li class="nav-list-item">
    ...
    <header class="header">
      ...
      <div class="header-box">
        ...
        <div class="order-by"><strong>Your friendly neighbourhood cocktail bar.</strong> </div>
        
        <div class="order-by">
       
          Closed Mondays. Tues-Sun 6pm-2am.
         
        </div>
        <div class="order-by">
       
          Full food menu till close.
        </div>
        <div class="order-by">
