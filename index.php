...
<!-- class is "nav-sticky" -->
    <header class="header">
      ...
      <div class="header-box">
        ...
        <div class="order-by"><strong>Order cut off is 10am</strong> </div>
        
        <div class="order-by">
       
        Same day delivery via courier (Downtown Toronto)
         
        </div>
        <div class="order-by">
       
          Next day delivery via shipping (GTA / Canada)
        </div>
        <div class="order-by">
       
          <strong>Reopening Feb 1st, 2022. 6pm-2am Daily.</strong>
        </div>
        <div class="order-by">
